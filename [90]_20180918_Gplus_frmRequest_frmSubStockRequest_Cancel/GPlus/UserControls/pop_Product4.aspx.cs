...
{
    public partial class pop_Product4 : Pagebase
    {
        ...
        protected void gvItem_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                btnSelect.Attributes.Add("onclick", "if(window.opener){" +
                    ...
                    "window.opener.document.getElementById('" + Request["name"] + "').value = '" + drv["Item_Search_desc"].ToString() + "'; " +
        ...
        {
            DataSet ds = new DataAccess.ItemDAO().GetItemPack2(txtProductCode.Text, txtProductName.Text, "", "1", PagingControl1.CurrentPageIndex,
