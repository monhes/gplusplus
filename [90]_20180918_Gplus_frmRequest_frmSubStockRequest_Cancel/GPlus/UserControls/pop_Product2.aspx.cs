...
{
    public partial class pop_Product2 : Pagebase
    {
        ...
        protected void gvItem_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                btnSelect.Attributes.Add("onclick", "if(window.opener){" +
                    ...
                    "if (typeof(window.opener.document.getElementById('btnRefreshSelect')) != \"undefined\" && window.opener.document.getElementById('btnRefreshSelect') != null)" +
