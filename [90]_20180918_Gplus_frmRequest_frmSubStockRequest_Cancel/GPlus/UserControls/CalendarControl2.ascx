<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalendarControl2.ascx.cs" Inherits="GPlus.UserControls.CalendarControl2" %>
...
<table cellpadding="0" cellspacing="0" id="tblCalendar" runat="server">
    <tr>
        <td style="text-align: left; width: 80px" align="left" valign="middle">
            <asp:TextBox ID="txtDate" runat="server" Width="76" MaxLength="13" onblur="if(!isDate(this.value))this.focus();" />
