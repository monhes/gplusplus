<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_ProductMaterial.aspx.cs" Inherits="GPlus.UserControls.pop_ProductMaterial" %>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td style="width: 130px;" align="right">
                                            <asp:Label ID = "lblMaterailType" runat="server">ประเภทวัสดุอุปกรณ์ </asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtMaterialType" runat="server" MaxLength="30" Enabled = "false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 130px;" align="right">
                                            <asp:Label ID = "lblSubMaterialType" runat="server">ประเภทอุปกรณ์ย่อย </asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtSubMaterialType" runat="server" MaxLength="30" Enabled = "false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 130px;" align="right">
