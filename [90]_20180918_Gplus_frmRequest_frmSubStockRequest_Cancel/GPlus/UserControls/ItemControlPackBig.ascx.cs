...
{
    public partial class ItemControlPackBig : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                btnSelect1.OnClientClick = "open_popup('../UserControls/pop_ProductPackBig.aspx?id=" + hdID.ClientID +
                        "&code=" + txtItemCode.ClientID + "&name=" + txtItemName.ClientID +
                        "&pid=" + hdUnitID.ClientID + "&pname=" + txtPackName.ClientID + "&btnR=" + btnRefreshI.ClientID + "', 850, 400, 'popProduct1', 'yes', 'yes', 'yes');return false;";
            }
        }
        ...
        {
            LinkButton lb = this.Parent.FindControl("btnRefreshI") as LinkButton;

            string js = "document.getElementById('" + lb.ClientID + "').click();";

            ScriptManager.RegisterStartupScript(this, this.GetType(), "chk", js, true);
        }
    }
}