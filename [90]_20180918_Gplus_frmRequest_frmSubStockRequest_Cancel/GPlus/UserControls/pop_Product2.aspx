<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_Product2.aspx.cs" Inherits="GPlus.UserControls.pop_Product2" %>
                                ...
                                <asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="false" Width="97%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="หน่วยนับ" DataField="Description" SortExpression="Description"
                                            ItemStyle-HorizontalAlign="Left" />
                                            <asp:BoundField HeaderText="หน่วยฟรี" DataField="Description" Visible="False" />
                                    </Columns>
                                </asp:GridView>
                            </td>
                        </tr>
