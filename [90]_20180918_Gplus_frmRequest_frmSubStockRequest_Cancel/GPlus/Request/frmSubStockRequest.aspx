<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="frmSubStockRequest.aspx.cs" Inherits="GPlus.Request.frmSubStockRequest" %>
    ...
    <script language="javascript" type="text/javascript">
        function OpenEmployeePopup(orgId) {
            if (window.showModalDialog) {
                retVal = window.showModalDialog("dgEmplyeeRequest.aspx?OrgId=" + orgId, 'Show Popup Window', "unadorned:yes;dialogHeight:400px;dialogWidth:550px;resizable:no;scrollbars:yes");
                __doPostBack('__Page', '');
            }
        }
        ...
        <tr>
            <td class="tableBody">
                <table cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td colspan="7">
                        <uc4:orgcontrol ID="orgCtrl" runat="server" Visible="False" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                        &nbsp;&nbsp;&nbsp;
                            <asp:DropDownList runat="server" ID="ddlStock" Width="150px" 
                                style=" float:right; margin-left:10px;" 
                                onselectedindexchanged="ddlStock_SelectedIndexChanged" >
                                <asp:ListItem Text="คลังย่อยสาขาเชียงใหม่" Value="" />
                          
                            </asp:DropDownList>
                            <asp:Label ID="lbConsider0"  style=" float:right;" runat="server" 
                                Font-Size="Medium">คลัง</asp:Label>
                        </td>
                      ...
                      <td style="width:150px" align="right"></td>
                        <td colspan="3">
                            ...
                            <fieldset style="width:auto;">
                                        <legend>สถานะใบเบิก</legend>
                                  <asp:RadioButton ID="rdb_request_status_waitpay" runat="server" Text="รอการจ่าย" 
                                    GroupName="request_status"  />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdb_request_status_payed" runat="server" Text="จ่ายแล้ว" GroupName="request_status" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdb_request_status_existpay" runat="server" Text="ค้างจ่าย" GroupName="request_status" />

                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdb_request_status_cancel" runat="server" Text="ยกเลิก" GroupName="request_status" />
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RadioButton ID="rdb_request_status_all" runat="server" Text="ทั้งหมด" Checked="true" GroupName="request_status" />
                    ...
                    <tr>
                        <td style="width:150px" align="right">เลขที่ใบเบิก</td>
                        <td>
                        ...
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                       <%-- <td style="width:200px" align="right">หน่วยงาน</td>
                        <td>
                            <asp:TextBox runat="server" ID="txtDeptName" Width="200px" Enabled="false" />
                        </td>--%>
                    </tr>
                    <tr>
                        <td style="width:150px" align="right">วันที่</td>
                        <td style="width:110px">
                            <uc3:CalendarControl runat="server" ID="ccForm" />
                        </td>
                        <td style="width:10px" align="center">-</td>
                        <td colspan="2">
                            <uc3:CalendarControl runat="server" ID="ccTo" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width:150px" align="right">ชื่อ</td>
                        <td colspan="4">
...
<%--                                                                <asp:TextBox runat="server" ID="tbItemCode" Width="140px" Enabled="false" onkeypress="return tbItemCodeSearch(event);" /> --%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:150px">
                                                                <asp:Button ID="btnReOrderPoint" runat="server"  SkinID="ButtonMiddle"  
                                                                    Text="Reorder Point" Width="100px" onclick="btnReOrderPoint_Click" />
                                     ...
                                     OnClick="btnRefreshItem_Click" Style="display:none;"></asp:LinkButton>
                                                                                       ...
                                                                                       <asp:LinkButton ID="btnRefreshItem2" runat="server" Text="Refresh" CausesValidation="false"
                                     OnClick="btnRefreshItem2_Click" Style="display:none;"></asp:LinkButton>

                                        <asp:LinkButton ID="btnRefreshItem3" runat="server" Text="Refresh" CausesValidation="false"
                                     OnClick="btnRefreshItem3_Click" Style="display:none;"></asp:LinkButton>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style2">
                                            <div style="width: 100%; max-height: 200; overflow:auto" >
                                                <asp:GridView runat="server" ID="gvStockPay" AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvStockPayRowDataBound" OnRowCommand="gvStockPayRowCommand"  SkinId="GvNormal">
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnDetail" runat="server" Text="รายละเอียดการรับ" CommandName="Selectt"
                                                   ...
                                                   <%--     <asp:TemplateField HeaderText="ครั้งที่การจ่าย" ItemStyle-HorizontalAlign ="Center" >
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="btnSelect" Text='<%# "ครั้งที่ "+Eval("row_num") %>'  ItemStyle-HorizontalAlign="Center" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                          <asp:BoundField HeaderText="ครั้งที่การจ่าย" DataField="row_num" ItemStyle-HorizontalAlign="Center" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <asp:GridView ID="gvRequestItem" runat="server" AutoGenerateColumns="false"
                                                        OnRowDataBound="GvRequestItemRowDataBound"  SkinID ="GvLong"
                                                        OnRowCreated="GvRequestItem_RowCreated" Width="100%" >
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="จำนวนที่รับ">
                                                                <ItemTemplate>
                                                                    <%--<asp:TextBox ID="txt_RecQty" runat="server" AutoPostBack="true" 
                                                                      ...
                                                                      onKeyPress="return NumberBoxKeyPress(event, 0, 46, false)" onKeyUp="return NumberBoxKeyUp(event, 0, 46, false)" onpaste="return CancelKeyPaste(this)"
                                                                        Width="50px" Text='<%# Eval("data_rec_qty") %>'></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle Width="40px" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="แตก Pack" Visible = "false">
                                                                <ItemTemplate>
                                                   ...
                                                   <asp:TemplateField Visible="false">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnSaveLot" runat="server"  Text="บันทึกรับ" CommandName="ViewReceive"
                                                                CausesValidation="false"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:HiddenField runat="server" ID = "packId" /> 
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
...
<script type="text/javascript">
    ...
    function ChkDataRec() {
        ...
        for (var i = 3; i < gv1.rows.length; ++i) {
            ...
            var PayQtyObj = gv1.rows[i].cells[7].childNodes[0];
            var RecQtyObj = gv1.rows[i].cells[8].childNodes[0];
            var CommentObj = gv1.rows[i].cells[10].childNodes[0];
    ...
    function ChkDataOrder() {
        ...
        if (gv1 != null) {
            ...
            //            alert(gv1.rows.length);
            for (var i = 2; i < gv1.rows.length; ++i) {

                var OrderQtyObj = gv1.rows[i].cells[5].childNodes[0];
