<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dgEmplyeeRequest3.aspx.cs" Inherits="GPlus.reports.dgEmplyeeRequest3" %>
                         ...
                         <asp:GridView ID="gvEmployee" runat="server" AutoGenerateColumns="false" Width="100%" AllowSorting="true" OnRowCommand="GvEmployeeRowCommand" OnRowDataBound="GvEmployeeRowDataBound">
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="btnSelect" CommandName="Edi" Text="เลือก"  />
                                    </ItemTemplate>
                                </asp:TemplateField>
