<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="True"
    CodeBehind="ReceiveAndWithdrawCaseOtherReport.aspx.cs" Inherits="GPlus.PRPO.ReceiveAndWithdrawCaseOtherReport" MaintainScrollPositionOnPostback="true"%>
...
<%@ Register Src="~/UserControls/SupplierDropdownControl.ascx" TagName="SupplierDDLCtrl" TagPrefix="uc3" %>
    ...
    <table cellpadding="0" cellspacing="0" width="805">
        <tr>
            <td class="tableHeader">
                รายงานสรุปรายการรับเข้า – จ่ายออกสินค้ากรณีอื่นๆ
            </td>
        </tr>
        <tr>
            <td class="tableBody">
                <table width="90%">
                            ...
                            <fieldset style="width:300px">
                                <legend>ประเภท</legend>
                                 <asp:RadioButtonList ID="rdbType" runat="server" RepeatDirection="Horizontal"  AutoPostBack="true">
                                    <asp:ListItem Text="รายการรับ" Selected="True" Value="G"></asp:ListItem>
                                    <asp:ListItem Text="รายการจ่ายออก" Value="U"></asp:ListItem>
                                    <asp:ListItem Text="Adjust Stock" Value="W"></asp:ListItem>
                                </asp:RadioButtonList>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan = "3">
                            <uc3:SupplierDDLCtrl ID="supplierDdlCtrl" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                         <td style="width: 130px;" align="right">
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%"
                    ...
                    <LocalReport ReportPath="Stock/ReceiveAndWithdrawCaseOtherReport.rdlc">
                    </LocalReport>
                </rsweb:ReportViewer>
