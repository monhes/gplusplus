<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_PRForm2Report.aspx.cs" Inherits="GPlus.PRPO.pop_PRForm2Report" %>
...
<head runat="server">
    <title>พิมพ์ใบบัญชีค่าใช้จ่าย</title>
            ...
            <tr>
                <td class="tableBody">
                    ...
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                        ...
                        <LocalReport ReportPath="PRPO\PRForm2Report.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                    </div>
                </td>
