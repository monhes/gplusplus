<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_POPrintAttachReport.aspx.cs" Inherits="GPlus.PRPO.pop_POPrintAttachReport" %>
...
<head runat="server">
    <title>ใบอนุมัติค่าใช้จ่ายสต๊อก</title>
        ...
        <table cellpadding="0" cellspacing="0" width="800">
            ...
            <tr>
                ...
                <%--    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                        ...
                        <LocalReport ReportPath="PRPO\POAttachReport2.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>--%>
                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                            Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
