<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_PRSelect.aspx.cs" Inherits="GPlus.PRPO.pop_PRSelect" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="3">
                                            ...
                                            <asp:CheckBox ID="chkApprove" runat="server" Checked="true" Text="PR รอออกใบสั่งซื้อ" />
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <asp:GridView ID="gvPR" runat="server" AutoGenerateColumns="false" Width="97%" 
                                    AllowSorting="false" onrowdatabound="gvPR_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:BoundField HeaderText="จำนวน" DataField="Unit_Quantity" SortExpression="Unit_Quantity" ItemStyle-HorizontalAlign="Right" />
                                        ...
                                        <asp:BoundField HeaderText="ทีม/ฝ่าย" DataField="Dep_Name" SortExpression="Dep_Name"/>
