<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_ProductSelect.aspx.cs"
    Inherits="GPlus.PRPO.pop_ProductSelect" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="false" 
                                    Width="97%" AllowSorting="false" onrowdatabound="gvItem_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:BoundField HeaderText="หน่วย" DataField="Description" SortExpression="Description"
                                                ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField HeaderText="Supplier" DataField="Supplier_Name" SortExpression="Supplier_Name" />
                                        <asp:BoundField HeaderText="ราคาต่อหน่วย" DataField="Unit_Price" SortExpression="Unit_Price" />
