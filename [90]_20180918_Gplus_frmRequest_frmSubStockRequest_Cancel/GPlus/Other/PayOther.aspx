<%@ Page Title="" Language="C#"   AutoEventWireup="true" Inherits="Other_PayOther" 
MasterPageFile="~/MasterPage/Main.Master" MaintainScrollPositionOnPostback="true"  Codebehind="PayOther.aspx.cs" %>
...
//             str_table = str_table + " </td><td></td> </tr> </table>  </td>";
             ...
             str_table = str_table + "<td> ราคาต่อหน่วย : </td><td colspan = 3> <input id = 'txt_priceDetail" + int_lot + "' value = '" + cLotPrice + "' name = 'txt_priceDetail" + int_lot + "' type ='text' onchange='JavaScript:calTotalLot(\"" + int_lot + "\")' style='width:150px' /> บาท </td></tr>";
         ...
         function clear() {
             ...
             $("#ContentPlaceHolder1_uc_payDate_txtDate").val(output);
             //$("#ContentPlaceHolder1_uc_payDate_txtDate").val("");
             $("#ContentPlaceHolder1_drp_typePay").val("");
             $("#ContentPlaceHolder1_drp_supplier").val("");
             $("#txt_preSend").val("");
             $("#hid_preSend").val("")

             $("#txt_prePay").val($("#ContentPlaceHolder1_hidUserFName").val() + " " + $("#ContentPlaceHolder1_hidUserLName").val());
             $("#hid_prePay").val($("#ContentPlaceHolder1_hidUser").val())
         ...
         function btn_saveOnClick() {
             ...
             if ($("#ContentPlaceHolder1_drp_typePay").val() == "") {
             ...
             $.ajax({
                 type: "POST",
                 url: "jsonService.asmx/savePay",
                 data: "{'str_payID':'" + $("#txt_payID").val() + "','str_payDate':'" + $("#ContentPlaceHolder1_uc_payDate_txtDate").val() + "','str_typePay':'" + $("#ContentPlaceHolder1_drp_typePay").val() + "','str_give':'" + $("#txt_give").val() + "','str_preSend':'" + $("#hid_preSend").val() + "','str_prePay':'" + $("#hid_prePay").val() + "','str_stock':'" + $("#ContentPlaceHolder1_drp_searchStock").val() + "','str_user':'" + $("#ContentPlaceHolder1_hidUser").val() + "'}",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
                     var resultH = data.d;
         ...
         function GetTableSearch() {
             ...
             $.ajax({
                 type: "POST",
                 url: "jsonService.asmx/GetSearchPay",
                 data: "{'str_sort': '','str_rowPer':'10','str_rowStart' :'1','str_dateStart' :'" + $("#ContentPlaceHolder1_uc_searchDateStart_txtDate").val() + "','str_dateEnd' :'" + $("#ContentPlaceHolder1_uc_searchDateEnd_txtDate").val() + "','str_pay' :'" + $("#txt_searchPayID").val() + "','str_stock' :'" + $("#ContentPlaceHolder1_drp_searchStock").val() + "'}",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
                     var resultH = data.d;
                     ...
                     if (int_max > 0) {
                         ...
                         str_table = str_table + "<th> <div align='center'>เลขที่</div></th> ";
                         str_table = str_table + "<th> <div align='center'>วันที่จ่าย</div></th> ";
                         str_table = str_table + "<th> <div align='center'>จ่ายให้แก่</div></th> ";
                         str_table = str_table + "<th> <div align='center'>ผู้จ่ายออก</div></th> ";
                         str_table = str_table + "<th> <div align='center'>ผู้อนุมัติ</div></th> ";
                         ...
                         while (i < int_max) {
                             ...
                             str_table = str_table + "<td>" + resultH[i].sendUser + "</td>";
         ...
         function GetTableHeadLot(obj) {
             ...
             $.ajax({
                 type: "POST",
                 url: "jsonService.asmx/GetHeadLotDetailPay",
                 contentType: "application/json; charset=utf-8",
                 ...
                 success: function (data) {
                     ...
                     if (int_max > 0) {
                         ...
                         //str_table = "<table id='table-2'><thead><th><div align='center'>ลำดับ</div></th> ";
                         str_table = "<table BackColor='#3A8FE3' style='color: White;width:780px'' CellSpacing='1' CellPadding='1'> <tr class = 'GridHeader' ><th><div align='center'>ลำดับ</div></th>";
                         str_table = str_table + "<th Style=GridHeader > <div align='center'>ลบ</div></th> ";
         ...
         function selectedUser(userID, userName) {
             ...
             $("#hid_preSend").val(userID);
             $("#txt_preSend").val(userName);
             hideModal('tablePopup');

         }

         function selectedUserPay(userID, userName) {

             $("#hid_prePay").val(userID);
             $("#txt_prePay").val(userName);
             hideModal('tablePopupPay');
         ...
         function img_searchUser_Click() {
             ...
             $.ajax({
                 ...
                 data: "{'str_lotUser':'" + $("#txt_preSend").val() + "'}",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
                     var resultH = data.d;
         ...
         function img_searchUserPay_Click() {

             $.ajax({
                 type: "POST",
                 url: "jsonService.asmx/GetUser",
                 data: "{'str_lotUser':'" + $("#txt_prePay").val() + "'}",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
                     var resultH = data.d;
                     ...
                     if (int_max > 0) {
                         ...
                         while (i < int_max) {
                             ...
                             str_table = str_table + "<td><a href='JavaScript:selectedUserPay(\"" + resultH[i].Value + "\",\"" + resultH[i].Text + "\");'>เลือก</a></td>";
                             str_table = str_table + "<td>" + (i + 1) + "</td>";
                             str_table = str_table + "<td>" + resultH[i].Text + "</td>";
                             str_table = str_table + "</tr>";
                             i++;
                         ...
                         str_table = str_table + "</table>";
                         $("#tableSearchPay").html(str_table);

                         revealModal('tablePopupPay');
                     }
                     else {
                         alert("ไม่พบข้อมูล");
                     }
         ...
         function GetHead(transactionID, payID, payDate, type, refNumber, supplier,supplierID, payUser, payUserID, sendUser, reason, createBy, createDate, updateBy, updateDate, stockID, flag) {

             clearHead();
             $("#txt_payID").val(payID);
             $("#ContentPlaceHolder1_uc_payDate_txtDate").val(convertToDateServerByString(payDate));
             
            // $("#ContentPlaceHolder1_drp_supplier").val(supplier);
             $("#ContentPlaceHolder1_drp_typePay").val(type);
             //$("#txt_remark").val(reason);
             $("#ContentPlaceHolder1_drp_searchStock").val(stockID);

             $("#txt_give").val(sendUser);
             $("#txt_prePay").val(supplier);
             $("#hid_prePay").val(supplierID);
             $("#txt_preSend").val(payUser);
             $("#hid_preSend").val(payUserID);
                 ...
                 success: function (data) {
                     ...
                     while (i < int_max) {
                         ...
                         if (i == 0) {
                             ...
                             $("#txt_priceDetail" + (i + 1) + "").val((resultH[i].priceOther).formatMoney(4, '.', ''));
         ...
         function btn_deleteOnClick() {
           ...
           if (confirm('ต้องการยกเลิก')) {
                 $.ajax({
                     ...
                     data: "{'str_ID':'" + $("#txt_payID").val() + "','str_type':'P','str_user':'" + $("#ContentPlaceHolder1_hidUser").val() + "'}",
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     success: function (data) {
                         GetTableSearch();
    ...
    <td class="style3">
        ...
        <tr>
            ...
            <td colspan = "3" align =left>
                ...
                <input type ="text" style="width:150px" ID="txt_searchPayID" />
            </td>
        </tr>
        <tr>
            <td align=right>
        ...
        <tr>
          ...
          <input  type="button" value="ค้นหา" name="btn_search" 
                    ...
                    Style="background-image: url('../Images/button.png'); color:White;background-color:Transparent;border-style:None;background-repeat:no-repeat; cursor: pointer;margin: 4px 4px 4px 4px; width: 76px;" forecolor="white" 
    Height="25" 
...
&nbsp;
    ...
    Height="25" 
            ...
            <td colspan = 2 align =left>
                <input  type="button" value="เพิ่มการจ่ายสินค้าออก" name="btn_pay"  
                 onclick="JavaScript:btn_payOnClick()"BackColor="Transparent" 
                                             BorderStyle="None" 
                                             Style="background-image: url('../Images/button_mll.png');color:White;background-color:Transparent;border-style:None; background-repeat:no-repeat; cursor: pointer;margin: 4px 4px 4px 4px; width: 190px;" forecolor="white" 
    ...
    <tr>
       ...
       <td  class="tableBody">
            <%--style="display:none"--%>&nbsp;<table id = "payHead" border = 0 cellpadding = 0 cellspacing = 0 >
                    <tr>
                        <td>
                            ...
                            <table style="width: 762px" >
                                <tr>
                                    ...
                                    <td style="text-align: left" class="style22">
                                        <input type ="text" style="width:150px" id="txt_payID" name = "txt_payID" readonly />
                                    </td>
                                    ...
                                    <td  style="text-align: left" class="style7" >
                                         <uc2:CalendarControl id="uc_payDate" runat="server" />
                                ...
                                <tr>
                                    ...
                                    <td  style="text-align: left" class="style22" >
                                        <asp:DropDownList ID="drp_typePay" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="text-align: right" >
                                        ผู้จ่ายออก 
                                    ...
                                    <td  colspan = 3 style="text-align: left">
                                        <input type ="text" style="width:150px" id="txt_prePay" name="txt_prePay"  />
                                        <input type = "hidden" id = "hid_prePay" />
                                        <img  src="../images/icon_zoom.png" onclick="JavaScript:img_searchUserPay_Click()" />
                                    </td>
                                </tr>
                                <tr>
                                      <td style="text-align: right"  >
                                          ผู้อนุมัติ :</td>
                                    <td style="text-align: left" class="style22" >
                                        <input type ="text" style="width:150px" id="txt_preSend" name = "txt_preSend" />
                                        <input type = "hidden" id = "hid_preSend" />
                                    ...
                                    <td  class="style19" colspan = 3 >
                                        ...
                                        <input type ="text" style="width:150px" id="txt_give" name = "txt_give" />
                                ...
                                <tr>
                                    <td colspan=6 align=left style="text-align: center">
                                         <input  type="button" value="ลบ" name="btn_pay" 
                                         onclick="JavaScript:btn_deleteDetailOnClick()"  BorderStyle="None" 
                                             Style="background-image: url('../Images/button.png'); color:White;background-color:Transparent;border-style:None;background-repeat:no-repeat; cursor: pointer;margin: 4px 4px 4px 4px; width: 74px;" forecolor="white" 
    Height="25" onmouseout="this.style.backgroundImage = 'url(../Images/button.png)';this.style.color = 'white';" 
                                             onmouseover="this.style.backgroundImage = 'url(../Images/button_over.png)';this.style.color = '#EC467E';" />
                                         <input  type="button" value="เพิ่มรายการจ่ายออกกรณีอื่นๆ" name="btn_pay" 
                                         onclick="JavaScript:btn_addPayOnClick()" BackColor="Transparent" 
                                             BorderStyle="None" 
                                             Style="background-image: url('../Images/button_mll.png');color:White;background-color:Transparent;border-style:None; background-repeat:no-repeat; cursor: pointer;margin: 4px 4px 4px 4px; width: 190px;" forecolor="white" 
    Height="25" onmouseout="this.style.backgroundImage = 'url(../Images/button_mll.png)';this.style.color = 'white';" 
                                             onmouseover="this.style.backgroundImage = 'url(../Images/button_mll_over.png)';this.style.color = '#EC467E';" />
                                    ...
                                    <td colspan = 6>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                     <input type ="text" style="width:150px" ID="txt_createDate" readonly />
                                                </td>
                                                <td align=right>
                                                    ผู้สร้าง : 
                                                </td>
                                                <td>
                                                     <input type ="text" style="width:150px" ID="txt_create" readonly />
                                                </td>
                                            </tr>
                                             <tr>
                                                <td align=right>
                                                ...
                                                <td>
                                                     <input type ="text" style="width:150px" ID="txt_updateDate" readonly />
                                                </td>
                                                <td align=right>
                                                    ผู้แก้ไขล่าสุด : 
                                                </td>
                                                <td>
                                                     <input type ="text" style="width:150px" ID="txt_update" readonly />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<script type="text/javascript">
            ...
            <td class="tableBody">
                <table class="none" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                             <select name="drp_productPack" id="drp_productPack" ></select>
                        </td>
                        </tr>
                        <tr>
                        <td align="right"> 
                        ...
                        <td>
                             <input  type="button" value="Add Lot NO." name="btn_addLotNo" 
                                         onclick="JavaScript:CreateNewRowLot('','','','','','')" BackColor="Transparent" BorderStyle="None" Style="background-image: url(../Images/button_mll.png);color:White;background-color:Transparent;border-style:None;background-repeat:no-repeat; cursor: pointer;margin: 4px 4px 4px 4px;" Width="185" forecolor="white" 
                    ...
                    <tr>
                        ...
                        <table>
                            <tr>
                                ...
                                BorderStyle="None" 
                                Style="background-image: url('../Images/button_mll.png'); color:White;background-color:Transparent;border-style:None;background-repeat:no-repeat; cursor: pointer;margin: 4px 4px 4px 4px; width: 191px;" forecolor="white" 
    Height="25" 
 ...
 <a href="javascript:hideModal('tablePopup')"><img src="../images/close.png"   border=0 ></a></div>
     ...
     <div class="modalPage3"  id = "tablePopupPay" >
    <div class="modalBackground3" >
    </div>
    <div class="modalContainer3">
        <div class="modal3" style="text-align: left">
      <div align="right">
 <a href="javascript:hideModal('tablePopupPay')"><img src="../images/close.png"   border=0 ></a></div>
            <div class="modalBody3" style="text-align: left"> 
            <table style="background-image: url(../Images/Stock/bg.jpg); padding-top: 7px;">
             <tr>
                    <td class="tableHeader" align="left">
