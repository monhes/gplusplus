<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="Supplier_content.aspx.cs" Inherits="GPlus.ReportLog.Supplier_content" %>
            ...
            <td class="tableBody">
                <table width="100%">
                    ...
                    <tr>
                            ...
                            <td colspan="1">
                            <asp:TextBox ID="txt_Supplier7" runat="server" MaxLength="30" Width="115px"></asp:TextBox>
                            </td>
                            <td></td>
